package com.app.modules.materials.util;

import com.app.common.exception.FileStorageException;
import com.app.common.exception.InvalidFileException;
 ...
 * Manages file uploads, downloads, and validation for study materials.
 */
@Component
public class FileStorageUtil {
     ...
     * Checks file is not empty, is a PDF, and does not exceed 20MB.
     *
    ...
    private void validateFile(MultipartFile file) {
        ...
        if (file.getSize() > MAX_FILE_SIZE) {
            throw new InvalidFileException("File size exceeds the maximum allowed size of 20MB.");
        }
    }
