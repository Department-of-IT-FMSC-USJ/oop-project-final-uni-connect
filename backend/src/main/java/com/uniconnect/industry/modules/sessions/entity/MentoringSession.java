package com.uniconnect.industry.modules.sessions.entity;
...
@Entity(name = "IndustryMentoringSession")
@Table(name = "industry_mentoring_sessions")
public class MentoringSession {
    ...
    public MentoringSession(Integer sessionId, Integer mentorId, String sessionTitle,
                             ...
                             LocalDate sessionDate, LocalTime sessionTime, LocalDateTime createdDate) {
