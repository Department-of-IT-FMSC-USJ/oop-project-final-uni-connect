package com.academicmentor.common.exception;
...
/**
 * Global exception handler for the academic mentor application.
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handle duplicate session exceptions (sessions module).
     */
    @ExceptionHandler(DuplicateSessionException.class)
    public ResponseEntity<ApiResponseDTO<Void>> handleDuplicateSessionException(
    ...
    /**
     * Handle duplicate allocation exceptions (allocations module).
     */
    ...
    /**
     * Handle mentor capacity exceeded exceptions (allocations module).
     */
    @ExceptionHandler(MentorCapacityExceededException.class)
    public ResponseEntity<ApiResponseDTO<Void>> handleMentorCapacityExceededException(
            MentorCapacityExceededException ex) {
