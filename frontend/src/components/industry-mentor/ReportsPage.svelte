<script>
  ...
  async function generateReport() {
    ...
    expandedSessions = {};
    try {
      const res = await api.get(`/reports/mentor/industry/session-report?startDate=${startDate}&endDate=${endDate}`);
      reportData = res.data;
    } catch (err) {
...
<DashboardLayout navItems={industryMentorNavItems} activeItem="reports" pageTitle="Reports">
