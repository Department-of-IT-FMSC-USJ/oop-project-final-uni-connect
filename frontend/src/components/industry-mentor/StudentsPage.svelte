                ...
                <div class="student-head">
                  <div class="student-identity">
                    {#if student.profilePicture}
                      <img src={student.profilePicture} alt={student.fullName} class="student-avatar student-avatar-img" />
                    {:else}
                      <div class="student-avatar">{getInitial(student.fullName)}</div>
                    {/if}
                    <div class="student-title-block">
                      ...
                      >{student.fullName || 'Unknown'}</button>
                      <span class="student-reg">{student.registrationNumber || 'No Reg. No.'}</span>
                    </div>
                  </div>
                  <span class="year-chip">Year {student.yearOfStudy || '-'}</span>
                </div>
      ...
      <div class="modal-content profile-modal">
        ...
        <div class="profile-body">
          <div class="profile-avatar-row">
            <div class="profile-avatar-lg">{getInitial(selectedProfile.fullName)}</div>
            <div>
